...
<body class="login-page-bg">
    <section class="login-container">
        <div class="login-card">
            ...
            <form method="post" action="" id="driver-register-form">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="username" id="reg-username" placeholder="Choose a username" required value="<?php echo isset($_POST['username']) ? htmlspecialchars($_POST['username']) : ''; ?>">
                </div>
